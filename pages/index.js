...
export default function Home() {
  ...
  return (
    <section className='w-screen h-screen bg-black'>
      ...
      <section
        className='flex flex-row items-center justify-center py-48 bg-blue-200 rounded-xl max-lg:flex-col'
        ref={tutorialRef}
      >
        <Image
        ...
        <div className='w-1/3 ml-32 max-lg:w-full max-lg:ml-0 max-lg:p-5'>
          <h2 className='mb-6 font-sans text-5xl font-semibold text-black max-lg:text-3xl'>
            당신만의 노래 리스트를 생성하세요.
          </h2>
          <p className='font-sans text-xl font-normal text-black max-lg:text-lg '>
            노래책은 노래리스트를 여러 개 만들 수 있어요. 각 리스트마다 주제를
            정해놓고 알맞은 곡을 저장해보세요.
          </p>
        </div>
      </section>
      <section className='flex flex-row items-center justify-center py-48 bg-blue-400 rounded-xl max-lg:flex-col'>
      ...
      <section className='flex flex-row items-center justify-center py-48 bg-blue-200 rounded-xl max-lg:flex-col'>
        <Image
      ...
      <section className='flex flex-col items-center justify-center py-48 bg-white rounded-xl'>
        <h2 className='mb-6 font-sans text-5xl font-semibold text-black max-lg:text-center'>
          자 그럼 시작하러 가볼까요?
        </h2>
        <PrimaryBtn
          handleClick={handleClickLoginBtn}
